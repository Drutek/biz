        ...
        @if($currentThread)
            ...
            <div class="flex-1 overflow-y-auto p-4 space-y-4" id="messages-container">
                ...
                @if($isStreaming)
                    <div class="flex justify-start">
                        <div class="bg-zinc-100 text-zinc-800 dark:bg-zinc-700 dark:text-zinc-100 max-w-[80%] rounded-lg px-4 py-3">
                            <div class="whitespace-pre-wrap" wire:stream="streamingResponse">{{ $streamingResponse }}</div>
            ...
            <div class="border-t border-zinc-200 p-4 dark:border-zinc-700">
                <form wire:submit="sendMessage" class="flex gap-2">
                    ...
                    />
                    <flux:button type="submit" variant="primary" :disabled="$isStreaming">
                        @if($isStreaming)
